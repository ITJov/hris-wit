...
SELECT
       ubr.id, ubr.name, ubr.access, ubr.is_all_access, ubr.level, ubr.created_at, ubr.created_by, ubr.updated_at, ubr.updated_by, ubr.deleted_at, ubr.deleted_by
FROM
...
RETURNING user_backoffice_role.id, user_backoffice_role.name, user_backoffice_role.access, user_backoffice_role.is_all_access, user_backoffice_role.level, user_backoffice_role.created_at, user_backoffice_role.created_by, user_backoffice_role.updated_at, user_backoffice_role.updated_by, user_backoffice_role.deleted_at, user_backoffice_role.deleted_by
`
...
SELECT ubr.id, ubr.name, ubr.access, ubr.is_all_access, ubr.level, ubr.created_at, ubr.created_by, ubr.updated_at, ubr.updated_by, ubr.deleted_at, ubr.deleted_by FROM user_backoffice_role ubr
WHERE
    (CASE WHEN $1::bool THEN LOWER(ubr.name) LIKE LOWER($2) ELSE TRUE END)
    AND ubr.deleted_at IS NULL
