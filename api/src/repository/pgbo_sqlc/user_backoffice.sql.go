...
SELECT
       ub.id, ub.guid, ub.name, ub.profile_picture_image_url, ub.phone, ub.email, ub.role_id, ub.password, ub.salt, ub.is_active, ub.created_at, ub.created_by, ub.updated_at, ub.updated_by, ub.deleted_at, ub.deleted_by, ub.last_login, ub.id_pegawai,
